...
export default function DashboardLayout({
  ...
  return (
    <div className="dashboard-minimal relative flex min-h-screen overflow-hidden bg-[#F8FAFC] text-[#0f172a] print:block print:h-auto print:overflow-visible print:bg-white">
      ...
      <div className="relative z-10 flex min-h-screen w-full flex-col overflow-hidden print:h-auto print:min-h-screen md:flex-row">
        <AdminSidebar />
        <main className="relative z-10 flex-1 overflow-y-auto bg-transparent print:overflow-visible print:bg-white print:text-black">
          <div className="relative z-10 mx-auto h-full w-full max-w-[1580px] space-y-6 px-3 py-4 md:px-6 md:py-6 print:h-auto print:min-h-screen print:overflow-visible">
